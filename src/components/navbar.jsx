    ...
    return (
        <div style={{ backgroundColor: '#0F101C',minHeight:'100vh'}}>
            <div style={{
                ...
                <button style={{ backgroundColor: 'blue', color: 'white', padding: 5, borderRadius: 5, borderColor: 'blue', borderWidth: 1.5, fontSize: 10 }}>WEBSITE</button>
                <button style={{ backgroundColor: 'green', color: 'white', padding: 5, borderRadius: 5, marginLeft: 5, fontSize: 10 }}>CONNECT</button>
            </div>
            <div style={{ display: 'flex'}}>
                <div style={{ flex: 1, color: 'white', padding:70 }}>

                    <h1 style={{ padding: 10, margin: 5 }}>
                        Stake Your <span style={{color: 'green'}}>$ Token</span> and Earn 20% Interest on Staked Token
                    </h1>
                    ...
                    <button style={{ backgroundColor: '#1C1D39', color: 'white', padding: 5, marginLeft: 5, fontSize: 15 }}>Current Token Price
                        <div style={{ color: 'green' }}>1.384 USDT</div>
                    </button>
                </div>
                <div style={{ backgroundColor: '#0F101C', flex: 1 }}>
                      <div style= {{display: 'flex', alignItems: 'center', justifyContent: 'space-evenly'}}>
                        ...
                        <div style={{backgroundColor: '#1C1D39', padding:5, margin: 5}}>
                            ...
                            <div style={{ color: 'green', textAlign:'center' }}>50 USDT</div>
                        </div>
                        <div style={{backgroundColor: '#1C1D39', padding:5, margin: 5}}>
                           <div style= {{color: 'white', fontSize: 15}}>Max Staking Amount</div>
                            <div style={{ color: 'green',textAlign: 'center' }}>500 USDT</div>
                        </div>
                    </div>
                        <div>
                            <table 
                            style={{color: 'white',
                                ...
                                <tr>
                                    ...
                                    <div style={{background: 'rgba(217,217,217,0.2)', borderRadius:12, height: 24}}>
                                        <div style={{background: 'green', color: 'black', width: `${filled*100}%`, textAlign: 'center', borderTopLeftRadius: 12, borderBottomLeftRadius:12, height: '100%'}}>
                                            {filled*100} % filled
                                        </div>
                                    </div>
                                    </td>
